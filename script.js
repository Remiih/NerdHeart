(function () {
  ...
  var Confetti = function (options) {
    ...
    t.vars = {
      ...
      confettiColors: ['#191970', '#4682B4', '#6A5ACD', '#E0F2F7'], // Midnight Blue, Steel Blue, Slate Blue, Light Cyan
  ...
  const card = cardWrapper; // Assuming 'card' should reference 'cardWrapper'
  ...
  new Granim({
    ...
    states: {
      "default-state": {
        gradients: [
        ['#191970', '#E0F2F7'], // Midnight Blue to Light Cyan
        ['#4682B4', '#BBDEFB'], // Steel Blue to Light Blue
        ['#6A5ACD', '#D8BFD8']] // Slate Blue to Thistle
      }
    }
  });
